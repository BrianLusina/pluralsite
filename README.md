...
2. **Clone this repository.** - `git clone https://github.com/BrianLusina/pluralvision.git` or [download the zip](https://github.com/BrianLusina/pluralvision.git/archive/master.zip)
