...
2. **Clone this repository.** - `git clone https://github.com/BrianLusina/pluralsite.git` or [download the zip](https://github.com/BrianLusina/pluralsite.git/archive/master.zip)
